...
/**
 * Abstract sponge implementation with a 1024-bit state and 1024-bit output.
 * It provides a specific round function for the 1024-bit sponge permutation.
 */
public abstract class AbstractSponge1024 : AbstractSponge(16, 16) {

    /**
     * Performs the round function for the 1024-bit sponge, applying diffusion, confusion, and mask updates.
     */
    override fun round() {
