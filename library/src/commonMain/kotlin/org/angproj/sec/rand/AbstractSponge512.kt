...
/**
 * Abstract sponge implementation with a 512-bit state and 512-bit output.
 * It provides a specific round function for the 512-bit sponge permutation.
 */
public abstract class AbstractSponge512 : AbstractSponge(9, 8) {

    /**
     * Performs the round function for the 512-bit sponge, applying diffusion, confusion, and mask updates.
     */
    override fun round() {
