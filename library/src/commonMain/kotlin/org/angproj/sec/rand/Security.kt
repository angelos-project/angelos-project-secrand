 ...
 */
public abstract class Security: Octet.Producer {
     ...
     *
     * @param dst The LongArray to fill with random numbers.
     */
     ...
     *
     * @param dst The data structure to fill with random bytes.
