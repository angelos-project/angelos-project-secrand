 ...
 * @property article The instance of the object to benchmark.
 *
...
public abstract class BenchmarkArticle<B>(protected val article: B) {
    ...
    /**
     * The size in bytes of each sample generated by the benchmark object.
     */
    public abstract val sampleByteSize: Int

    /**
     * Generates and returns the next sample as a byte array.
     *
